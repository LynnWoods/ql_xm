<template>
    <view class="setPass">
        ...
        <view class="setIpt">
            <input type="password" v-if="iptType == 'password'" v-model="formData.pasw" placeholder="请输入新的登录密码"placeholder-style="color: #c4c4c4">
            <input type="text" v-else v-model="formData.pasw" placeholder="请输入新的登录密码"placeholder-style="color: #c4c4c4">
            <image :src="passShow" @click="showPass"></image>
        </view>
        <view class="btnBox">
            <button class="cu-btn" @click="setPasw">确定</button>
        </view>
    </view>
</template>
